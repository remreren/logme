...
class Logme private constructor() {
    init {
    ...
    open class DebugTree : Tree() {
        private val fqcnIgnore = listOf(
                Logme::class.java.name,
                Logme.Forest::class.java.name,
    ...
    open class DatabaseTree(context: Context) : DebugTree() {
        ...
        override fun log(priority: Int, tag: String?, message: String, t: Throwable?) {
            Thread(Runnable { db.logDao().insertAll(LogModel(message, priority, DateTime.now())) }).start()
